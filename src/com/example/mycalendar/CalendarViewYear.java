...
public class CalendarViewYear extends Activity implements AdapterView.OnItemSelectedListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_calendar_view_year);
		...
		viewType.setSelection(2);
	}

	@Override
	public boolean onCreateOptionsMenu(Menu menu) {
		// Inflate the menu; this adds items to the action bar if it is present.
		getMenuInflater().inflate(R.menu.calendar_view_year, menu);
		return true;
	}
	...
	public void onItemSelected(AdapterView<?> arg0, View arg1, int arg2,
		...
		Utility.changeView(arg1, this, this, selectedView, "Year");
